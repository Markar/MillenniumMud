...
class BareHand:
    ...
    def at_pre_attack(self, wielder, **kwargs):
        ...
        # print(f"at_pre_attack on weapon: {wielder} and {wielder.traits.ep.value} and self {self}")
    ...
    def at_attack(self, wielder, target, **kwargs):
        ...
        wielder.traits.ep.value -= energy_cost
...
class MeleeWeapon(Object):
    ...
    def at_attack(self, wielder, target, **kwargs):
        ...
        wielder.traits.ep.value -= self.attributes.get("energy_cost", 0)
