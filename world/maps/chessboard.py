...
PROTOTYPES = {
    ...
    (3, 1): {
        "typeclass": "typeclasses.rooms.MobRoom",
        "spawn_proto": "FAYDWER_SKELETON",
        "tags": [("chessboard", "zone")],
        "key": "Light square of a chessboard",
        "desc": "|YOn the light square of the chessboard, a skeleton lies sprawled, its bony fingers still clutching a rusted sword. The hollow eye sockets seem to stare into the void, and tattered remnants of armor cling to its frame, telling tales of battles long forgotten.",
    },
    (3, 2): {
        "typeclass": "typeclasses.rooms.MobRoom",
        "spawn_proto": "FAYDWER_SKELETON",
        "tags": [("chessboard", "zone")],
        "key": "Dark square of a chessboard",
        "desc": "|YOn the dark square of the chessboard, a skeleton lies sprawled, its bony fingers still clutching a rusted sword. The hollow eye sockets seem to stare into the void, and tattered remnants of armor cling to its frame, telling tales of battles long forgotten.",
    },
    (3, 3): {
        "typeclass": "typeclasses.rooms.MobRoom",
        "spawn_proto": "FAYDWER_SKELETON",
